...
const CarReservationsPage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        setLoading(true);
        const carData = await fetchAllPendingCarReservations();
  ...
  const totalPages = Math.ceil(carReservations.length / itemsPerPage);
      ...
      <div className="container">
        <div className="text-center mb-10">
          ...
          <p className="text-base text-body-color mt-3 max-w-xl mx-auto">
            View and manage all car reservations here.
          </p>
        </div>
